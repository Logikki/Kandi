    ...
    nämä mittaukset ovat. Tutkielma käsittelee myös sitä, miten nämä mittaukset riippuvat ulkoisista muuttujista.
     Tulokset osoittavat, että laitteet suoriutuvat matkan pituuden, korkeuden, sykkeen ja askeleiden mittauksesta hyvin.
      Unen mittauksessa laitteet mittaavat unen pituuden tarkasti, mutta unen vaiheiden erottelu ei ole tarkkaa. 
       Laitteet eivät myöskään suoriudu happisaturaation mittaudesta kovin hyvin.
}
 ...
 Consumers rely on these measurements and adjust their training programs or rest periods according to the device's measurements.
  This Bachelor's thesis explores how accurate these measurements are. The thesis also examines how these measurements depend on external variables.
   The results show that the devices perform well in measuring distance, elevation, heart rate, and steps. In sleep measurement, the devices accurately measure the length of sleep,
    but the differentiation between sleep stages is not very accurate. The devices also do not perform very well in measuring oxygen saturation.
}
